...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_15 -L zynq_ultra_ps_e_vip_v1_0_15 -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_14 -L xlconcat_v2_1_5 -L xlconstant_v1_1_8 -L smartconnect_v1_0 -L axi_register_slice_v2_1_29 -L util_reduced_logic_v2_0_5 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot system xil_defaultlib.system xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim system -key {Behavioral:sim_1:Functional:system} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_24fc.protoinst" -protoinst "protoinst_files/bd_31bd.protoinst" -protoinst "protoinst_files/bd_c0fd.protoinst" -protoinst "protoinst_files/bd_d5b8.protoinst" -protoinst "protoinst_files/bd_15e9.protoinst" -protoinst "protoinst_files/system.protoinst" -log simulate.log
}
